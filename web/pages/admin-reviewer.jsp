...
<div class="mdui-row"
    ...
    <div class="mdui-appbar mdui-ripple background-color height"
        ...
        <a href="<%=host%>/pages/admin.jsp" class="mdui-typo-headline mdui-text-color-white"
...
<div class="mdui-table-fluid">
    <table class="mdui-table mdui-table-hoverable">
        ...
        <tr>
            ...
            <% String
                    a = "<form action='" + host + "/pages/admin-reviewer-modify.jsp' method='get'><input type='hidden' name='id' value='" + reviewer.getId() + "'/><button class='mdui-btn mdui-color-pink-accent mdui-ripple' type='submit'>修改</button></form>" +
